...
@section('subtitle')
    Don't have an account? <a href="{{ route('register.form') }}" class="font-bold text-red-500 hover:text-pink-500 transition-colors">Sign Up</a>
@endsection
...
<form action="{{ route('login.post') }}" method="POST" class="space-y-6">
    ...
    <div x-data="{ show: false }">
        <div class="flex items-center justify-between mb-1.5">
            ...
            <a href="{{ route('password.request') }}" class="text-xs font-bold text-red-500 hover:text-pink-500 transition-colors">Forgot password?</a>
        </div>
        <div class="relative group">
            <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-gray-400 group-focus-within:text-red-500 transition-colors">
